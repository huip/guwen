...
class Index_model extends CI_Model
{
  ...
  public function index($pages)
  {
    ...
    $sql = "SELECT us.user_img,us.user_name,us.user_id,ms.msgid,ms.post_time,
         ms.ques_title,ms.ques_socore,ms.browser,
       IF(is_best = 0,'未解决','已解决') AS is_best, '$numpage' AS num,(SELECT count(*) FROM guwen_comment WHERE comment_quesid = ms.msgid) AS anwser,
