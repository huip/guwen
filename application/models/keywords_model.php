	...
	public function __construct()
	{
      ...
      public function get_relative_ques($ques_id)
      {
          ...
          foreach ($res as $key => $value) {
           ...
           $sql = "SELECT keywords ,ques_id FROM guwen_keywords WHERE ques_id !=?";
           $query = $this->db->query($sql,array($ques_id));
           ...
           else
           {
            ...
            foreach ($realativewords as $key => $value) {
                ...
                $sql = "SELECT ques_title,msgid,ques_cate,(SELECT COUNT(id) FROM guwen_comment WHERE comment_quesid = '$value[ques_id]') AS anwser FROM guwen_message  WHERE msgid = '$value[ques_id]'";
