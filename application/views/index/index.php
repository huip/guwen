            ...
            <div class="ques-list span12">
            	<div class="feed-list span11">
            		...
            		<div class="feed-content span11">
            			<p class="feed-content-name"><span><a class="user-name-title" href="<?=base_url()?>index.php/person/question/<?=$value['user_id']?>" ><?=$value['user_name'];?></a></span>
            			       <a href="<?=base_url()?>index.php/question/index/<?=$value['msgid'];?>"   class="title-a"><?=$value['ques_title'];?></a><span class="sns-time-list pull-right"><?=$value['post_time'];?></span>
                          </p>
