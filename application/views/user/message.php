  ...
  <div class="row-fluid">
  	<div class="span12">
  		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?=base_url();?>index.php/user/message">我的消息</a></li>
		</ul>
		<div class="usercnt-list span7 pull-left">
                <?php foreach ($message_info as $key => $value):{?>
                          ...
                          <?} endforeach;?></a>回答了你的提问<a href="<?=base_url();?>index.php/question/index/<?=$value['msgid']?>"><?=$value['ques_title'];?></a></div>
