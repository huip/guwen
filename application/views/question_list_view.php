    ...
    <div class="span9">
    	<div class="list_info span10">
    		...
    		<p class="sns-bar question_info" qid="<?=$value['msgid'];?>" >
    			<span>提问者:<a href="<?=base_url();?>index.php/usercenter/person_question/<?=$value['user_id']?>"><?=$value['user_name'];?></a></span>
    	...
    	<div class="comment-list span10">
                        ...
                        <div class="comment-list-info span12" cid ="<?=$value['id']?>">
                                    <a href="<?=base_url();?>index.php/usercenter/person_question/<?=$value['user_id']?>"><img src="<?=$value['user_img'];?>" class="span1" /></a>
                                    <div class="comment-intro span10" uid="<?=$value['comment_uid']?>">
                                        <p><a href="<?=base_url();?>index.php/usercenter/person_question/<?=$value['user_id']?>"><?= $value['user_name'];?></a>
