$(function(){
      ...
      var create_quescontent_bok = false;
...
$("#formsubmit").click(function() {
      if( create_questitle_bok&&create_quescontent_bok&&create_quescore_bok&&create_quescate_bok ){
          ...
          return ques_error_tip("请填写内容！","error");
...
$(".create-cate span").click(function() {
      ...
      var bok = false;
      if($cate_name == "") {
          $(".ques-error-tip").html("请填写分类名！").css("color","#b94a48");
      }else {
...
$('.question-content').blur(function() {
      var msg;
        if($(this).val() == "") {
            msg = "请填写问题正文!";
            create_quescontent_bok = ques_error_tip(msg,"error");
        }
           ...
           create_quescontent_bok = ques_error_tip("","success");
        }
})
...
function get_root_path() {  
  var root = location.protocol + '//' + location.host+'/wen/index.php/';
  return root;
}
